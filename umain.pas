...
uses
  Classes, SysUtils, Forms, Controls, Graphics, Dialogs, Menus, uLogin, Unit1, frnDetail, frnTransaksi, frnDataCustomer, frnLaporan; // Tambahkan unit uLogin di sini
...
procedure TForm5.menuCustomerClick(Sender: TObject);
begin
  // Membuat objek Form4
...
procedure TForm5.menuLaporanClick(Sender: TObject);
begin
     // Membuat objek Form7
